...
public class MainActivityBindingImpl extends MainActivityBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.btn_scan_vin, 2);
        sViewsWithIds.put(R.id.btn_scan_rego, 3);
        sViewsWithIds.put(R.id.btn_scan_barcode, 4);
        sViewsWithIds.put(R.id.btn_scan_qrcode, 5);
        sViewsWithIds.put(R.id.btn_scan_driver, 6);
        sViewsWithIds.put(R.id.btn_scan_car, 7);
        sViewsWithIds.put(R.id.imageView, 8);
        sViewsWithIds.put(R.id.toolbar, 9);
        sViewsWithIds.put(R.id.txt_app_version, 10);
    }
    // views
    @NonNull
