...
public class SearchItemBindingImpl extends SearchItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txt_value, 2);
        sViewsWithIds.put(R.id.txt_location, 3);
        sViewsWithIds.put(R.id.txt_floor, 4);
        sViewsWithIds.put(R.id.txt_bay, 5);
        sViewsWithIds.put(R.id.txt_name, 6);
        sViewsWithIds.put(R.id.txt_time, 7);
        sViewsWithIds.put(R.id.txt_compare, 8);
    }
    // views
    // variables
    // values
